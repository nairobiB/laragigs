...
<x-layout>
    ...
    <div class="mx-4">
        <x-card class="p-10">
            <!-- I can add classes to x-card since i added the attributes and merging -->
            <div class="flex flex-col items-center justify-center text-center">
                <img class="w-48 mr-6 mb-6" src="{{$listing->logo ? asset('storage/' . $listing->logo): asset('/images/no-image.png')}}"  alt="" />
                <!-- ternary operator in the src so it can show the image in the db and if there is no image, it will show a default -->
