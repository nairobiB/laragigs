<x-layout>
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        <!-- x-card is used instead of a div, we have a "card" component with most of the properties needed for this form or div, we delete the repeated properties and just leave the new ones -->
        ...
        <form method="POST" action="/listings" enctype="multipart/form-data">
            <!-- Stops people from having a form on their website and submit to our page csrf -->
            @csrf
            <div class="mb-6">
                <label for="company" class="inline-block text-lg mb-2">Company Name</label>
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="company" value="{{old('company')}}" />
                <!-- in the value old() we are leaving the text withing the input so it doesnt delete once there is an error -->
                @error('company')
